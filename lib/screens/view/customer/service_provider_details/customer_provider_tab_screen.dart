...
class CustomerProviderTabScreen extends StatelessWidget {
  final RxInt selectedIndex = 0.obs;
  final List<String> tabs = ["Description", "Work", "Reviews","Education Proof","Work Proof"];
  ...
  CustomerProviderTabScreen({super.key});
    ...
    return Obx(
        ...
        children: [
          // Tabs Row
            ...
            child: SizedBox(
              height: 45, // Ensures horizontal scrolling works without constraints
